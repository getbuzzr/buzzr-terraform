...
resource "aws_ssm_parameter" "api_db_database_uri" {
  ...
  type  = "SecureString"
  value = "mysql://${aws_rds_cluster.prod_buzzr_aurora_cluster.master_username}:${data.aws_ssm_parameter.api_db_server_password.value}@${aws_rds_cluster.prod_buzzr_aurora_cluster.endpoint}/${aws_rds_cluster.prod_buzzr_aurora_cluster.database_name}"
}
