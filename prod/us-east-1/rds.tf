...
resource "aws_rds_cluster_instance" "cluster_instances" {
  ...
  cluster_identifier = aws_rds_cluster.buzzr_prod_cluster.id
  instance_class     = "db.t3.small"
  engine             = aws_rds_cluster.buzzr_prod_cluster.engine
  engine_version     = aws_rds_cluster.buzzr_prod_cluster.engine_version
...
resource "aws_rds_cluster" "buzzr_prod_cluster" {
